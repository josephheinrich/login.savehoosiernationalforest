...
if (isset($_SESSION['id']) && isset($_SESSION['user_name'])) {
    ...
    foreach ($chunkedEmailList as $chunk) {   
        ...
        //$email->setSubject(stripslashes($_POST['subject']));
        ...
        // $email->addDynamicTemplateData("mail_body", "mail_body");
        // $email->addDynamicTemplateData("mail_subject", "mail_subject");


        // $email->addContent(
        //     "text/html", 
        //     "<p>".stripslashes($messageWithLineBreaks)."</p>" +
        //     "<br>" +
        //     "<p>" +
        //         "<a href='https://savehoosiernationalforest.com/unsubscribe.php' target='_blank'>Unsubscribe.</a>" +
        //     "</p>"
        // );
